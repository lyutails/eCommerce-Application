      ...
      <form action="" className={style.form}>
        <div className={style.email}>
          <div className={style.email_wrapper}>
            ...
            <input className={style.email_wrapper_input} type="email" placeholder="E-mail" required />
          </div>
        ...
        <div className={style.password}>
          <div className={style.password_wrapper}>
            ...
            <input className={style.password_input} type="password" placeholder="Password" required />
